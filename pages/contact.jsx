      ...
      <div className=" px-4 py-2">
          ...
          <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
            <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-LightGray md:text-sm">Sila Insights</span>
              </div>
            </div>
            <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-LightGray text-sm">
                  amadsiddiqui619@gmail.com
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="md:text-base">Linkedin:</span>
                <span className="text-LightGray text-sm">amadsiddiqui</span>
              </div>
              <div className="flex justify-between items-center">
        ...
        <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
          <a
            ...
            href="mailto:amadsiddiqui619@gmail.com"
            target="_blank"
            rel="noreferrer"
          >
            <HiMail />
          ...
          <a
            className="hover:scale-125 ease-in-out duration-700"
            href="https://github.com/Amad-Ahmed"
            target="_blank"
            rel="noreferrer"
          >
            <FaGithub />
          ...
          <a
            className="hover:scale-125 ease-in-out duration-700"
            href="https://www.linkedin.com/in/amad-siddiqui/"
            target="_blank"
            rel="noreferrer"
          >
            <FaLinkedin />
          ...
          <a
            ...
            href="https://www.upwork.com/freelancers/~018f72ce558204b521?viewMode=1"
            target="_blank"
            rel="noreferrer"
          >
            <SiUpwork />
